...
const DropdownMenu = () => {
  ...
  return (
    <ul className="absolute z-30 bg-white top-24 right-14 max-sm:right-0 flex justify-center items-center flex-col gap-3 w-full sm:w-[200px] rounded-[10px] shadow-3xl px-4 py-2">
        ...
        <li key={333}>
          <button  onClick={profilenavigate} className="text-lg text-slate-gray hover:text-coral-red active:text-coral-red">
          Profile
          </button>
        </li>
...
const navLinks = [
    ...
    { href: "/Googlelink", label: "Google meet" },
